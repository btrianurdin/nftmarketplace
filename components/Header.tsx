    ...
    <div className={style.wrapper}>
      <Link href="/">
        <div className={style.logoContainer}>
          ...
          <div className={style.logoText}>NFTSELL</div>
        </div>
      </Link>
      <div className={style.searchBar}>
        ...
        <input type="text" className={style.searchInput} placeholder="Search items, collection, address" />
      </div>
      <div className={style.headerItems}>
        <Link href="/collections/xxx">
